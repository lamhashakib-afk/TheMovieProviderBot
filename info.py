...
API_ID = int(environ.get('API_ID', '29730289'))
API_HASH = environ.get('API_HASH', 'db500a41ff95a2d14394cf4221204c75')
BOT_TOKEN = environ.get('BOT_TOKEN', "8012955272:AAGX2I9ugtidqA-R541mmdjVeCGGYa2vPGc")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6182962779').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003026295500').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dvai6578_db_user:08bocKC8HU5fjTaS@shrabon.vttiowl.mongodb.net/?retryWrites=true&w=majority&appName=shrabon")
DATABASE_NAME = environ.get('DATABASE_NAME', "dvai6578_db_user")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/shrabonmovies')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003090086608')) #Log channel id ( make sure bot is admin )
